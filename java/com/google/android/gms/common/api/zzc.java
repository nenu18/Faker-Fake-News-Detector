...
public abstract class zzc<O extends ApiOptions> {
    ...
    public zzc(@NonNull Activity activity, Api<O> api, O o, zzabk zzabk) {
        this(activity, (Api) api, (ApiOptions) o, activity.getMainLooper(), zzabk);
    }
    ...
    public zzc(@NonNull Context context, Api<O> api, O o, zzabk zzabk) {
        this(context, (Api) api, (ApiOptions) o, Looper.myLooper() != null ? Looper.myLooper() : Looper.getMainLooper(), zzabk);
    }
    ...
    private <TResult, A extends zzb> Task<TResult> zza(int i, @NonNull zzabn<A, TResult> zzabn) {
    ...
    public <TResult, A extends zzb> Task<TResult> doBestEffortWrite(zzabn<A, TResult> zzabn) {
        return zza(2, (zzabn) zzabn);
    }
    ...
    public <TResult, A extends zzb> Task<TResult> doRead(zzabn<A, TResult> zzabn) {
        return zza(0, (zzabn) zzabn);
    }
    ...
    public Task<Void> doUnregisterEventListener(@NonNull zzaaz.zzb<?> zzb) {
        ...
        return this.zzaxK.zza(this, (zzaaz.zzb) zzb);
    }
    ...
    public <TResult, A extends zzb> Task<TResult> doWrite(zzabn<A, TResult> zzabn) {
        return zza(1, (zzabn) zzabn);
    }
