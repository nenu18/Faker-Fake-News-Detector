...
public final class DataHolder extends com.google.android.gms.common.internal.safeparcel.zza implements Closeable {
    ...
    private static final zza zzaCx = new C06231(new String[0], null);
    boolean mClosed;
    ...
    class C06231 extends zza {
        C06231(String[] strArr, String str) {
            super(strArr, str);
        }
    ...
    private DataHolder(zza zza, int i, Bundle bundle) {
        this(zza.zzaCq, zza(zza, -1), i, bundle);
    }
    ...
    private static CursorWindow[] zza(zza zza, int i) {
        int i2 = 0;
        if (zza.zzaCq.length == 0) {
            return new CursorWindow[0];
        }
        List zzb = (i < 0 || i >= zza.zzaCy.size()) ? zza.zzaCy : zza.zzaCy.subList(0, i);
        int size = zzb.size();
        CursorWindow cursorWindow = new CursorWindow(false);
        ArrayList arrayList = new ArrayList();
        arrayList.add(cursorWindow);
        cursorWindow.setNumColumns(zza.zzaCq.length);
        int i3 = 0;
        int i4 = 0;
        while (i3 < size) {
            try {
                ...
                boolean z = true;
                for (int i7 = 0; i7 < zza.zzaCq.length && z; i7++) {
                    String str = zza.zzaCq[i7];
                ...
                if (z) {
                    ...
                    cursorWindow3.setNumColumns(zza.zzaCq.length);
