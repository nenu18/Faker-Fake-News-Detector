...
public abstract class zzf<T extends IInterface> {
    ...
    private abstract class zza extends zze<Boolean> {
        ...
        protected zza(zzf zzf, int i, Bundle bundle) {
            this.zzaDV = zzf;
            super(zzf, Boolean.valueOf(true));
            this.statusCode = i;
            this.zzaDU = bundle;
        }
    ...
    protected final class zzk extends zza {
        ...
        @BinderThread
        public zzk(zzf zzf, int i, @Nullable Bundle bundle) {
            this.zzaDV = zzf;
            super(zzf, i, bundle);
        }
    ...
    protected zzf(Context context, Looper looper, int i, zzb zzb, zzc zzc, String str) {
        this(context, looper, zzn.zzaC(context), com.google.android.gms.common.zzc.zzuz(), i, (zzb) zzac.zzw(zzb), (zzc) zzac.zzw(zzc), str);
    }

    protected zzf(Context context, Looper looper, zzn zzn, com.google.android.gms.common.zzc zzc, int i, zzb zzb, zzc zzc2, String str) {
        ...
        this.zzaDG = (zzn) zzac.zzb((Object) zzn, (Object) "Supervisor must not be null");
        this.zzazw = (com.google.android.gms.common.zzc) zzac.zzb((Object) zzc, (Object) "API availability must not be null");
    ...
    public void zza(@NonNull zzf zzf) {
        this.zzaDJ = (zzf) zzac.zzb((Object) zzf, (Object) "Connection progress callbacks cannot be null.");
        zza(2, null);
    }
