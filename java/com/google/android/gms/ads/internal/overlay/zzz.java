...
public class zzz {
    ...
    public void onStop() {
        if (((Boolean) zzfx.zzBo.get()).booleanValue() && !this.zzOx) {
            ...
            for (zza zza : this.zzOp.getBuckets()) {
                valueOf = String.valueOf("fps_c_");
                valueOf2 = String.valueOf(zza.name);
                ...
                valueOf2 = String.valueOf(zza.name);
                bundle.putString(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf), Double.toString(zza.zzXs));
            }
