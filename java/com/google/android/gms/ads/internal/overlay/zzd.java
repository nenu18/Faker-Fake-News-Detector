...
public class zzd extends zzj implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C02386 implements Runnable {
        final /* synthetic */ zzd zzMs;
    ...
    class C02397 implements Runnable {
        final /* synthetic */ zzd zzMs;
    ...
    private void zzhe() {
        Throwable e;
        String valueOf;
        zzpe.m13v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzhf() {
        if (this.zzMe && zzhg() && this.zzMh.getCurrentPosition() > 0 && this.zzMg != 3) {
            zzpe.m13v("AdMediaPlayerView nudging MediaPlayer");
            zza(0.0f);
            this.zzMh.start();
    ...
    private void zzy(boolean z) {
        zzpe.m13v("AdMediaPlayerView release");
        if (this.zzMo != null) {
            this.zzMo.zzhP();
            this.zzMo = null;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzpe.m13v("AdMediaPlayerView completion");
        zzI(5);
        zzJ(5);
        zzpi.zzWR.post(new C02342(this));
    }
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzpe.m13v(new StringBuilder((String.valueOf(str).length() + 37) + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzpe.m13v("AdMediaPlayerView prepared");
        zzI(2);
        this.zzMd.zzhz();
        zzpi.zzWR.post(new C02331(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzpe.m13v("AdMediaPlayerView surface created");
        zzhe();
        zzpi.zzWR.post(new C02364(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzpe.m13v("AdMediaPlayerView surface destroyed");
        ...
        zzpi.zzWR.post(new C02386(this));
        zzy(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, final int i, final int i2) {
        Object obj = 1;
        zzpe.m13v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzpe.m13v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzMj = mediaPlayer.getVideoWidth();
        this.zzMk = mediaPlayer.getVideoHeight();
    ...
    public void pause() {
        zzpe.m13v("AdMediaPlayerView pause");
        if (zzhg() && this.zzMh.isPlaying()) {
            this.zzMh.pause();
            zzI(4);
            zzpi.zzWR.post(new C02408(this));
        }
        zzJ(4);
    }

    public void play() {
        zzpe.m13v("AdMediaPlayerView play");
        if (zzhg()) {
            this.zzMh.start();
            zzI(3);
            this.zzNj.zzhA();
            zzpi.zzWR.post(new C02397(this));
        }
        zzJ(3);
    }

    public void seekTo(int i) {
        zzpe.m13v("AdMediaPlayerView seek " + i);
        if (zzhg()) {
            this.zzMh.seekTo(i);
            this.zzMq = 0;
            return;
    ...
    public void stop() {
        zzpe.m13v("AdMediaPlayerView stop");
        if (this.zzMh != null) {
            this.zzMh.stop();
            this.zzMh.release();
            this.zzMh = null;
