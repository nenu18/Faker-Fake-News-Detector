...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzpy.m9e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzpy.m9e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzpy.m9e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzpy.m9e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzc(String str, String str2, String str3) {
        ...
        zzpy.m9e("Purchase verification failed: missing data.");
        return false;
    }
}
