...
public class zzc extends zzpd implements ServiceConnection {
    ...
    private void zze(long j) {
        do {
            if (!zzf(j)) {
                zzpe.m13v("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.zzOQ);
    }
    ...
    protected void zza(final zzf zzf, String str, String str2) {
        ...
        zzpi.zzWR.post(new Runnable(this) {
            ...
            public void run() {
                try {
                    if (this.zzOW.zzOU.zza(zzf.zzPf, -1, intent)) {
                        this.zzOW.zzIO.zza(new zzg(this.zzOW.mContext, zzf.zzPg, true, -1, intent, zzf));
                    } else {
                        this.zzOW.zzIO.zza(new zzg(this.zzOW.mContext, zzf.zzPg, false, -1, intent, zzf));
                    }
    ...
    protected void zzio() {
        if (!this.zzOT.isEmpty()) {
            ...
            for (zzf zzf : this.zzOT) {
                hashMap.put(zzf.zzPg, zzf);
            }
            String str = null;
            while (true) {
                ...
                for (int i = 0; i < stringArrayList.size(); i++) {
                    if (hashMap.containsKey(stringArrayList.get(i))) {
                        ...
                        if (zzf2.zzPf.equals(zzv.zzcX().zzaD(str2))) {
                            zza(zzf2, str2, str3);
                            hashMap.remove(str);
                        }
                    }
