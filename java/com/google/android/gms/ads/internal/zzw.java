...
public final class zzw implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzdo() {
            zzpe.m13v("Disable position monitoring on adFrame.");
            if (this.zzvP != null) {
                this.zzvP.zzkF();
            }
        }
        ...
        public void zzdt() {
            zzpe.m13v("Enable debug gesture detector on adFrame.");
            this.zzvQ = true;
        }

        public void zzdu() {
            zzpe.m13v("Disable debug gesture detector on adFrame.");
            this.zzvQ = false;
        }
    }
