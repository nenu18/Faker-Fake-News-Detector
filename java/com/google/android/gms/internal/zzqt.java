...
class zzqt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzqp {
    ...
    protected zzqt(zza zza, zzec zzec, boolean z, boolean z2, @Nullable zzav zzav, zzqa zzqa, zzgf zzgf, zzt zzt, zzd zzd) {
        super(zza);
        this.zzYX = zza;
        this.zzum = zzec;
        this.zzZd = z;
        ...
        zzv.zzcJ().zza((Context) zza, zzqa.zzaZ, settings);
    ...
    public void destroy() {
        synchronized (this.zzrN) {
            ...
            zzlI();
            this.zzZc = true;
            zzpe.m13v("Initiating WebView self destruct sequence in 3...");
            this.zzYZ.zzls();
        }
    }
    ...
    public void zza(com.google.android.gms.internal.zzcv.zza zza) {
        synchronized (this.zzrN) {
            this.zzZj = zza.zzxb;
        }
        zzO(zza.zzxb);
    ...
    public void zza(zzqu zzqu) {
        synchronized (this.zzrN) {
            if (this.zzZi != null) {
                zzpy.m9e("Attempt to create multiple AdWebViewVideoControllers.");
                return;
            }
            this.zzZi = zzqu;
        }
    ...
    public void zzla() {
        synchronized (this.zzrN) {
            zzpe.m13v("Destroying WebView!");
            zzpi.zzWR.post(new C04662(this));
        }
    }
