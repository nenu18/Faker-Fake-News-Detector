...
public final class zzaal extends GoogleApiClient implements com.google.android.gms.internal.zzaau.zza {
    ...
    final zzabq zzaAx;
    private final com.google.android.gms.common.internal.zzm.zza zzaAy = new C06531(this);
    ...
    class C06531 implements com.google.android.gms.common.internal.zzm.zza {
        final /* synthetic */ zzaal zzaAz;
    ...
    private void zza(final GoogleApiClient googleApiClient, final zzabl zzabl, final boolean z) {
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        final PendingResult zzabl = new zzabl((GoogleApiClient) this);
        if (this.zzaAr.containsKey(zzabx.zzahc)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzabx.API).addConnectionCallbacks(new ConnectionCallbacks(this) {
                ...
                public void onConnected(Bundle bundle) {
                    this.zzaAz.zza((GoogleApiClient) atomicReference.get(), zzabl, true);
                }
    ...
    public void disconnect() {
        ...
        try {
            ...
            this.zzaAt.release();
            for (com.google.android.gms.internal.zzzv.zza zza : this.zzaAl) {
                zza.zza(null);
                zza.cancel();
            }
            this.zzaAl.clear();
    ...
    public boolean hasConnectedApi(@NonNull Api<?> api) {
        ...
        zze zze = (zze) this.zzaAr.get(api.zzuH());
        boolean z = zze != null && zze.isConnected();
        return z;
    }
    ...
    public <C extends zze> C zza(@NonNull zzc<C> zzc) {
        Object obj = (zze) this.zzaAr.get(zzc);
        ...
        try {
            ...
            if (isResuming()) {
                ...
                while (!this.zzaAl.isEmpty()) {
                    com.google.android.gms.internal.zzzv.zza zza = (com.google.android.gms.internal.zzzv.zza) this.zzaAl.remove();
                    this.zzaAx.zzb(zza);
                    zza.zzA(Status.zzayj);
                }
            } else {
                t = this.zzaAk.zzb(t);
                this.zzazn.unlock();
