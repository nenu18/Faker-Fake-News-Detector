    ...
    public void zza(zzd zzd, zzdy zzdy, String str, zzoi zzoi, String str2) throws RemoteException {
        if (this.zzKU instanceof MediationRewardedVideoAdAdapter) {
            ...
            try {
                ...
                mediationRewardedVideoAdAdapter.initialize((Context) zze.zzE(zzd), new zzjy(zzdy.zzyF == -1 ? null : new Date(zzdy.zzyF), zzdy.zzyG, zzdy.zzyH != null ? new HashSet(zzdy.zzyH) : null, zzdy.zzyN, zzdy.zzyI, zzdy.zzyJ, zzdy.zzyU), str, new zzoj(zzoi), zza(str2, zzdy.zzyJ, null), zzdy.zzyP != null ? zzdy.zzyP.getBundle(mediationRewardedVideoAdAdapter.getClass().getName()) : null);
            } catch (Throwable th) {
    ...
    public void zza(zzd zzd, zzec zzec, zzdy zzdy, String str, String str2, zzju zzju) throws RemoteException {
        if (this.zzKU instanceof MediationBannerAdapter) {
            ...
            try {
                ...
                mediationBannerAdapter.requestBannerAd((Context) zze.zzE(zzd), new zzka(zzju), zza(str, zzdy.zzyJ, str2), com.google.android.gms.ads.zza.zza(zzec.width, zzec.height, zzec.zzzk), new zzjy(zzdy.zzyF == -1 ? null : new Date(zzdy.zzyF), zzdy.zzyG, zzdy.zzyH != null ? new HashSet(zzdy.zzyH) : null, zzdy.zzyN, zzdy.zzyI, zzdy.zzyJ, zzdy.zzyU), zzdy.zzyP != null ? zzdy.zzyP.getBundle(mediationBannerAdapter.getClass().getName()) : null);
            } catch (Throwable th) {
