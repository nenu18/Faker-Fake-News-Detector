...
public final class zzbum {
    ...
    public void zza(int i, zzbut zzbut) throws IOException {
        zzJ(i, 2);
        zzc(zzbut);
    }
    ...
    public void zzb(zzbut zzbut) throws IOException {
        zzbut.zza(this);
    }
    ...
    public void zzc(zzbut zzbut) throws IOException {
        zzqt(zzbut.zzacY());
        zzbut.zza(this);
    }
    ...
    public void zzkb(String str) throws IOException {
        try {
            ...
            zza zza = new zza(this.zzcrW.position(), this.zzcrW.limit());
            zza.initCause(e);
            throw zza;
        }
    }
