...
public final class zzef {
    ...
    public zzef(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0225R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0225R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0225R.styleable.AdsAttrs_adSizes);
        ...
        this.zztq = obtainAttributes.getString(C0225R.styleable.AdsAttrs_adUnitId);
