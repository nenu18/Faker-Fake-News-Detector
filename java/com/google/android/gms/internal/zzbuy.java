...
public interface zzbuy {
    ...
    public static final class zza extends zzbun<zza> implements Cloneable {
        ...
        public zza zzaO(zzbul zzbul) throws IOException {
            while (true) {
    ...
    public static final class zzb extends zzbun<zzb> implements Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            return (zzbur.zza(this.zzcsw, zzb.zzcsw) && this.zzcsx == zzb.zzcsx) ? (this.zzcrX == null || this.zzcrX.isEmpty()) ? zzb.zzcrX == null || zzb.zzcrX.isEmpty() : this.zzcrX.equals(zzb.zzcrX) : false;
        }
        ...
        public zzb zzaP(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
    ...
    public static final class zzc extends zzbun<zzc> implements Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.zzcsB != zzc.zzcsB || this.zzrn != zzc.zzrn || this.zzcbV != zzc.zzcbV || !zzbur.equals(this.zzcsC, zzc.zzcsC) || !Arrays.equals(this.zzcsD, zzc.zzcsD)) {
                return false;
            }
            if (this.zzcsE == null) {
                if (zzc.zzcsE != null) {
        ...
        public zzc zzaQ(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                int zzc;
                Object obj;
    ...
    public static final class zzd extends zzbun<zzd> implements Cloneable {
        ...
        public zzd zzaR(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
    ...
    public static final class zze extends zzbun<zze> implements Cloneable {
        ...
        public boolean equals(Object obj) {
            ...
            zze zze = (zze) obj;
            return (this.zzcsS == zze.zzcsS && this.zzcsT == zze.zzcsT) ? (this.zzcrX == null || this.zzcrX.isEmpty()) ? zze.zzcrX == null || zze.zzcrX.isEmpty() : this.zzcrX.equals(zze.zzcrX) : false;
        }
        ...
        public zze zzaS(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
