...
public interface zzes extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzes {
        ...
        private static class zza implements zzes {
            ...
            public zzen createAdLoaderBuilder(zzd zzd, String str, zzjs zzjs, int i) throws RemoteException {
            ...
            public zzkr createAdOverlay(zzd zzd) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IClientApi");
            ...
            public zzla createInAppPurchaseManager(zzd zzd) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IClientApi");
            ...
            public zzhb createNativeAdViewDelegate(zzd zzd, zzd zzd2) throws RemoteException {
                IBinder iBinder = null;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public zznr createRewardedVideoAd(zzd zzd, zzjs zzjs, int i) throws RemoteException {
                IBinder iBinder = null;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public zzeu getMobileAdsSettingsManager(zzd zzd) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IClientApi");
            ...
            public zzeu getMobileAdsSettingsManagerWithClientJarVersion(zzd zzd, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IClientApi");
    ...
    zzen createAdLoaderBuilder(zzd zzd, String str, zzjs zzjs, int i) throws RemoteException;

    zzkr createAdOverlay(zzd zzd) throws RemoteException;

    zzep createBannerAdManager(zzd zzd, zzec zzec, String str, zzjs zzjs, int i) throws RemoteException;

    zzla createInAppPurchaseManager(zzd zzd) throws RemoteException;

    zzep createInterstitialAdManager(zzd zzd, zzec zzec, String str, zzjs zzjs, int i) throws RemoteException;

    zzhb createNativeAdViewDelegate(zzd zzd, zzd zzd2) throws RemoteException;

    zznr createRewardedVideoAd(zzd zzd, zzjs zzjs, int i) throws RemoteException;

    zzep createSearchAdManager(zzd zzd, zzec zzec, String str, int i) throws RemoteException;

    zzeu getMobileAdsSettingsManager(zzd zzd) throws RemoteException;

    zzeu getMobileAdsSettingsManagerWithClientJarVersion(zzd zzd, int i) throws RemoteException;
}
