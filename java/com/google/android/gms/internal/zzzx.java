...
public abstract class zzzx<R extends Result> extends PendingResult<R> {
    static final ThreadLocal<Boolean> zzayN = new C04791();
    private boolean zzJ;
    ...
    class C04791 extends ThreadLocal<Boolean> {
        C04791() {
        }
    ...
    private void zzvd() {
        zzb zzb = (zzb) this.zzayT.getAndSet(null);
        if (zzb != null) {
            zzb.zzc(this);
        }
    }
