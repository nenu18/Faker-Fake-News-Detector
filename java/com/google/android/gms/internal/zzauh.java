...
public interface zzauh {
    ...
    public static final class zza extends zzbut {
        ...
        public zza zzP(zzbul zzbul) throws IOException {
            while (true) {
        ...
        public void zza(zzbum zzbum) throws IOException {
            ...
            if (this.zzbvR != null) {
                zzbum.zza(2, this.zzbvR);
            }
            if (this.zzbvS != null) {
                zzbum.zza(3, this.zzbvS);
            }
            if (this.zzbvT != null) {
    ...
    public static final class zzb extends zzbut {
        ...
        public boolean equals(Object obj) {
            ...
            zzb zzb = (zzb) obj;
            if (!zzbur.equals(this.zzbvV, zzb.zzbvV)) {
                return false;
            }
            if (this.name == null) {
                if (zzb.name != null) {
        ...
        public zzb zzQ(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
    ...
    public static final class zzc extends zzbut {
        ...
        public zzc zzR(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
    ...
    public static final class zzd extends zzbut {
        ...
        public zzd zzS(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
    ...
    public static final class zze extends zzbut {
        ...
        public boolean equals(Object obj) {
            ...
            if (!zzbur.equals(this.zzbwd, zze.zzbwd)) {
                return false;
            }
            if (!zzbur.equals(this.zzbwe, zze.zzbwe)) {
                return false;
            }
            if (this.zzbwf == null) {
                if (zze.zzbwf != null) {
            ...
            if (!zzbur.equals(this.zzbww, zze.zzbww)) {
                return false;
            }
            if (this.zzbqn == null) {
                if (zze.zzbqn != null) {
        ...
        public zze zzT(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                int zzc;
                Object obj;
        ...
        protected int zzv() {
            ...
            if (this.zzbww != null && this.zzbww.length > 0) {
                while (i2 < this.zzbww.length) {
                    zzbut zzbut3 = this.zzbww[i2];
                    if (zzbut3 != null) {
                        zzv += zzbum.zzc(29, zzbut3);
                    }
                    i2++;
                }
            }
    ...
    public static final class zzf extends zzbut {
        ...
        public boolean equals(Object obj) {
            ...
            zzf zzf = (zzf) obj;
            return !zzbur.equals(this.zzbwC, zzf.zzbwC) ? false : zzbur.equals(this.zzbwD, zzf.zzbwD);
        }
        ...
        public zzf zzU(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                int zzc;
                Object obj;
    ...
    public static final class zzg extends zzbut {
        ...
        public zzg zzV(zzbul zzbul) throws IOException {
            while (true) {
                int zzacu = zzbul.zzacu();
                switch (zzacu) {
                    case 0:
