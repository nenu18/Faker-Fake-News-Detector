...
public class zzkh implements MediationInterstitialAdapter {
    ...
    public void showInterstitial() {
        ...
        final AdOverlayInfoParcel adOverlayInfoParcel = new AdOverlayInfoParcel(new zzc(build.intent), null, new C07562(this), null, new zzqa(0, 0, false));
