...
public class zzaac implements zzaau {
    ...
    private class zza implements OnFailureListener, OnSuccessListener<Void> {
        ...
        public void onFailure(@NonNull Exception exception) {
            zzb zzb = (zzb) exception;
            this.zzazB.zzazn.lock();
            try {
                this.zzazB.zzazz = zzb.zzuK();
        ...
        public void zza(Void voidR) {
            ...
            try {
                ...
                for (zzc zzc : this.zzazB.zzazt.keySet()) {
                    this.zzazB.zzazz.put(((com.google.android.gms.common.api.zzc) this.zzazB.zzazt.get(zzc)).getApiKey(), ConnectionResult.zzawX);
                }
                zzvt();
                this.zzazB.zzazv.zzo(null);
                this.zzazB.zzazx.signalAll();
    ...
    public zzaac(Context context, Lock lock, Looper looper, com.google.android.gms.common.zzc zzc, Map<zzc<?>, zze> map, zzg zzg, Map<Api<?>, Integer> map2, com.google.android.gms.common.api.Api.zza<? extends zzaxn, zzaxo> zza, ArrayList<zzzy> arrayList, zzaal zzaal) {
        this.zzazn = lock;
        this.zzrx = looper;
        ...
        for (Entry entry : map.entrySet()) {
            ...
            this.zzazt.put((zzc) entry.getKey(), new zzaab(context, api2, looper, (zze) entry.getValue(), (zzzy) hashMap2.get(api2), zzg, zza));
        }
    ...
    public void connect() {
        ...
        try {
            if (!this.zzazy) {
                ...
                this.zzazz = null;
                this.zzazA = null;
                OnFailureListener zza = new zza();
                Executor zzact = new zzact(this.zzrx);
                this.zzaxK.zza(this.zzazt.values()).addOnSuccessListener(zzact, (OnSuccessListener) zza).addOnFailureListener(zzact, zza);
                this.zzazn.unlock();
            }
        } finally {
            this.zzazn.unlock();
