...
public class zzast extends zzatr {
    ...
    public long zza(String str, zza<Long> zza) {
        ...
        Object zzW = zzJq().zzW(str, zza.getKey());
        if (TextUtils.isEmpty(zzW)) {
            return ((Long) zza.get()).longValue();
        }
        try {
            return ((Long) zza.get(Long.valueOf(Long.valueOf(zzW).longValue()))).longValue();
    ...
    public int zzb(String str, zza<Integer> zza) {
        ...
        try {
            return ((Integer) zza.get(Integer.valueOf(Integer.valueOf(zzW).intValue()))).intValue();
        } catch (NumberFormatException e) {
            return ((Integer) zza.get()).intValue();
        }
    }
