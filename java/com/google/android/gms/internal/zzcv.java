...
public class zzcv implements ActivityLifecycleCallbacks, OnAttachStateChangeListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C03572 extends BroadcastReceiver {
        final /* synthetic */ zzcv zzwP;
    ...
    private void zzdT() {
        zzv.zzcJ();
        zzpi.zzWR.post(new C03561(this));
    }
    ...
    private void zzl(int i) {
        if (this.zzwN.size() != 0 && this.zzwK != null) {
            ...
            if (z3 || this.zzwn || i != 1) {
                zza zza = new zza(zzv.zzcP().elapsedRealtime(), this.zzwg.isScreenOn(), view != null ? zzv.zzcL().isAttachedToWindow(view) : false, view != null ? view.getWindowVisibility() : 8, zza(rect5), zza(rect), zza(rect2), z, zza(rect3), z2, zza(rect4), this.zzwO.density, z3);
