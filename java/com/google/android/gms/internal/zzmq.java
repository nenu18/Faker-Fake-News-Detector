...
public interface zzmq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmq {
        ...
        private static class zza implements zzmq {
            ...
            public void zza(zzmh zzmh, zzmr zzmr) throws RemoteException {
            ...
            public zzmk zzd(zzmh zzmh) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.request.IAdRequestService");
                    ...
                    obtain2.readException();
                    zzmk zzmk = obtain2.readInt() != 0 ? (zzmk) zzmk.CREATOR.createFromParcel(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return zzmk;
                } catch (Throwable th) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    if (parcel.readInt() != 0) {
                        zzmh = (zzmh) zzmh.CREATOR.createFromParcel(parcel);
                    }
                    zzmk zzd = zzd(zzmh);
                ...
                case 2:
                    ...
                    zza(zzmh, com.google.android.gms.internal.zzmr.zza.zzaf(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(zzmh zzmh, zzmr zzmr) throws RemoteException;

    zzmk zzd(zzmh zzmh) throws RemoteException;
}
