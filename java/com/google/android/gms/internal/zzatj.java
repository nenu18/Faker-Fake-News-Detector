...
public class zzatj extends zzats {
    ...
    private class zzc implements Runnable {
        ...
        public zzc(zzatj zzatj, String str, URL url, byte[] bArr, Map<String, String> map, zza zza) {
            this.zzbsb = zzatj;
            zzac.zzdv(str);
            zzac.zzw(url);
            zzac.zzw(zza);
    ...
    public void zza(String str, URL url, Map<String, String> map, zza zza) {
        ...
        zzac.zzw(url);
        zzac.zzw(zza);
        zzJs().zzn(new zzc(this, str, url, null, map, zza));
    }
    ...
    public void zza(String str, URL url, byte[] bArr, Map<String, String> map, zza zza) {
        ...
        zzac.zzw(bArr);
        zzac.zzw(zza);
        zzJs().zzn(new zzc(this, str, url, bArr, map, zza));
    }
