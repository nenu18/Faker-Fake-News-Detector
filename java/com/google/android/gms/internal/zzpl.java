...
public class zzpl {
    ...
    class C04563 implements OnClickListener {
        C04563(zzpl zzpl) {
        }
    ...
    class C04585 implements Runnable {
        final /* synthetic */ zzpl zzXg;
    ...
    private void zzku() {
        if (this.mContext instanceof Activity) {
            ...
            if (resources != null) {
                string = resources.getString(C0225R.string.debug_menu_title);
            } else {
                Object obj = "Select a Debug Mode";
            }
            String string2 = resources != null ? resources.getString(C0225R.string.debug_menu_ad_information) : "Ad Information";
            String string3 = resources != null ? resources.getString(C0225R.string.debug_menu_creative_preview) : "Creative Preview";
            String string4 = resources != null ? resources.getString(C0225R.string.debug_menu_troubleshooting) : "Troubleshooting";
    ...
    private void zzkv() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setNegativeButton("Close", new C04563(this));
            builder.create().show();
            return;
        }
        zzpy.zzbd("Can not create dialog without Activity Context");
    ...
    private void zzkw() {
        ...
        zzph.zza(new C04574(this));
    }

    private void zzkx() {
        zzpy.zzbc("Debug mode [Troubleshooting] selected.");
        zzph.zza(new C04585(this));
    }
