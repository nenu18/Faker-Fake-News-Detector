...
public class zzato extends zzats {
    ...
    private final class zzb implements UncaughtExceptionHandler {
        ...
        public zzb(zzato zzato, String str) {
            this.zzbsX = zzato;
            zzac.zzw(str);
            this.zzbsW = str;
        }
    ...
    private final class zzc<V> extends FutureTask<V> implements Comparable<zzc> {
        ...
        zzc(zzato zzato, Runnable runnable, boolean z, String str) {
            this.zzbsX = zzato;
            super(runnable, null);
            zzac.zzw(str);
            this.zzbsW = str;
            ...
            if (this.zzbsY == Long.MAX_VALUE) {
                zzato.zzJt().zzLa().log("Tasks index overflow");
            }
        }

        zzc(zzato zzato, Callable<V> callable, boolean z, String str) {
            this.zzbsX = zzato;
            super(callable);
            zzac.zzw(str);
            this.zzbsW = str;
        ...
        public int zzb(@NonNull zzc zzc) {
    ...
    private final class zzd extends Thread {
        ...
        public zzd(zzato zzato, String str, BlockingQueue<FutureTask<?>> blockingQueue) {
            this.zzbsX = zzato;
            zzac.zzw(str);
