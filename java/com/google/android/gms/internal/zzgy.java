...
public class zzgy extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    @Nullable
    zzgn zzc(zzgv zzgv) {
        return zzgv.zza((OnClickListener) this);
    }
    ...
    public void zze(zzd zzd) {
        synchronized (this.zzrN) {
            ...
            if (zzE instanceof zzgv) {
                ...
                zzgv.zza(this.zzGI, this.zzGJ, (OnTouchListener) this, (OnClickListener) this);
