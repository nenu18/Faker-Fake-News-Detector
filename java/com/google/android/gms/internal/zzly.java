...
public class zzly implements zza<zzgr> {
    ...
    private void zza(zzlu zzlu, JSONObject jSONObject, SimpleArrayMap<String, Future<zzgo>> simpleArrayMap) throws JSONException {
    ...
    public /* synthetic */ zzgu.zza zza(zzlu zzlu, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        return zzd(zzlu, jSONObject);
    }

    public zzgr zzd(zzlu zzlu, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
