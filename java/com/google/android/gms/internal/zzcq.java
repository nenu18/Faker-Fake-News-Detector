...
public class zzcq implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza implements zzcx {
        ...
        public View zzdO() {
            ...
            return zzgu != null ? zzgu.zzfV() : null;
        }
    ...
    void zza(zzcu zzcu, Map<String, String> map) {
    ...
    void zzb(zzqp zzqp, Map<String, String> map) {
        zza(zzqp.getView(), (Map) map);
    }
