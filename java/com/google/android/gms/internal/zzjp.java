...
public class zzjp implements zzjh {
    ...
    private void zza(final zzqf<zzjn> zzqf) {
        zzpi.zzWR.post(new Runnable(this) {
            ...
            public void run() {
                for (zzqf zzqf : this.zzKO.zzKL.keySet()) {
                    if (zzqf != zzqf) {
                        ((zzjm) this.zzKO.zzKL.get(zzqf)).cancel();
                    }
                }
            }
        });
    ...
    public zzjn zzd(List<zzji> list) {
        ...
        for (zzji zzji : list) {
            ...
            String valueOf = String.valueOf(zzji.zzJH);
            zzpy.zzbd(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
            for (String zzjm : zzji.zzJI) {
                final zzjm zzjm2 = new zzjm(this.mContext, zzjm, this.zzsD, this.zzKq, zzji, this.zzKG.zzRd, this.zzKG.zzvj, this.zzKG.zzvf, this.zzvW, this.zzKs, this.zzKG.zzvx, this.zzKG.zzvB);
                zzqf zza = zzph.zza(newCachedThreadPool, new Callable<zzjn>(this) {
                    ...
                    public zzjn zzgI() throws Exception {
                        synchronized (this.zzKO.zzrN) {
                            ...
                            return zzjm2.zza(this.zzKO.zzKH, this.zzKO.zzKI);
                        }
                    }
                });
