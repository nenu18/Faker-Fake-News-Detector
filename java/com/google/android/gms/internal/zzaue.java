...
public class zzaue extends zzats {
    ...
    public static String zza(zzb zzb) {
        ...
        zza(stringBuilder, 0, "filter_id", zzb.zzbvl);
        zza(stringBuilder, 0, "event_name", zzb.zzbvm);
        zza(stringBuilder, 1, "event_count_filter", zzb.zzbvp);
        stringBuilder.append("  filters {\n");
        zzc[] zzcArr = zzb.zzbvn;
    ...
    public static String zza(zze zze) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("\nproperty_filter {\n");
        zza(stringBuilder, 0, "filter_id", zze.zzbvl);
        zza(stringBuilder, 0, "property_name", zze.zzbvB);
        zza(stringBuilder, 1, zze.zzbvC);
        stringBuilder.append("}\n");
        return stringBuilder.toString();
    }
    ...
    private static void zza(StringBuilder stringBuilder, int i, zzc zzc) {
        if (zzc != null) {
            ...
            zza(stringBuilder, i, "complement", zzc.zzbvt);
            zza(stringBuilder, i, "param_name", zzc.zzbvu);
            zza(stringBuilder, i + 1, "string_filter", zzc.zzbvr);
            zza(stringBuilder, i + 1, "number_filter", zzc.zzbvs);
            zza(stringBuilder, i);
            stringBuilder.append("}\n");
        }
    }

    private static void zza(StringBuilder stringBuilder, int i, zzauh.zze zze) {
        if (zze != null) {
            zza(stringBuilder, i);
            stringBuilder.append("bundle {\n");
            zza(stringBuilder, i, "protocol_version", zze.zzbwc);
            zza(stringBuilder, i, "platform", zze.zzbwk);
            zza(stringBuilder, i, "gmp_version", zze.zzbwo);
            zza(stringBuilder, i, "uploading_gmp_version", zze.zzbwp);
            zza(stringBuilder, i, "config_version", zze.zzbwB);
            zza(stringBuilder, i, "gmp_app_id", zze.zzbqf);
            zza(stringBuilder, i, "app_id", zze.zzaR);
            zza(stringBuilder, i, "app_version", zze.zzbhg);
            zza(stringBuilder, i, "app_version_major", zze.zzbwx);
            zza(stringBuilder, i, "firebase_instance_id", zze.zzbqn);
            zza(stringBuilder, i, "dev_cert_hash", zze.zzbwt);
            zza(stringBuilder, i, "app_store", zze.zzbqg);
            zza(stringBuilder, i, "upload_timestamp_millis", zze.zzbwf);
            zza(stringBuilder, i, "start_timestamp_millis", zze.zzbwg);
            zza(stringBuilder, i, "end_timestamp_millis", zze.zzbwh);
            zza(stringBuilder, i, "previous_bundle_start_timestamp_millis", zze.zzbwi);
            zza(stringBuilder, i, "previous_bundle_end_timestamp_millis", zze.zzbwj);
            zza(stringBuilder, i, "app_instance_id", zze.zzbws);
            zza(stringBuilder, i, "resettable_device_id", zze.zzbwq);
            zza(stringBuilder, i, "device_id", zze.zzbwA);
            zza(stringBuilder, i, "limited_ad_tracking", zze.zzbwr);
            zza(stringBuilder, i, "os_version", zze.zzba);
            zza(stringBuilder, i, "device_model", zze.zzbwl);
            zza(stringBuilder, i, "user_default_language", zze.zzbwm);
            zza(stringBuilder, i, "time_zone_offset_minutes", zze.zzbwn);
            zza(stringBuilder, i, "bundle_sequential_index", zze.zzbwu);
            zza(stringBuilder, i, "service_upload", zze.zzbwv);
            zza(stringBuilder, i, "health_monitor", zze.zzbqj);
            zza(stringBuilder, i, zze.zzbwe);
            zza(stringBuilder, i, zze.zzbww);
            zza(stringBuilder, i, zze.zzbwd);
            zza(stringBuilder, i);
            stringBuilder.append("}\n");
        }
    }
    ...
    private static void zza(StringBuilder stringBuilder, int i, String str, zzd zzd) {
        if (zzd != null) {
            ...
            zza(stringBuilder, i, "match_as_float", zzd.zzbvw);
            zza(stringBuilder, i, "comparison_value", zzd.zzbvx);
            zza(stringBuilder, i, "min_comparison_value", zzd.zzbvy);
            zza(stringBuilder, i, "max_comparison_value", zzd.zzbvz);
            zza(stringBuilder, i);
            stringBuilder.append("}\n");
        }
    }
    ...
    private static void zza(StringBuilder stringBuilder, int i, String str, zzf zzf) {
        if (zzf != null) {
            ...
            zza(stringBuilder, i, "expression", zzf.zzbvE);
            zza(stringBuilder, i, "case_sensitive", zzf.zzbvF);
            if (zzf.zzbvG.length > 0) {
                zza(stringBuilder, i + 1);
                stringBuilder.append("expression_list {\n");
                for (String str2 : zzf.zzbvG) {
    ...
    private static void zza(StringBuilder stringBuilder, int i, String str, zzauh.zzf zzf) {
        int i2 = 0;
        if (zzf != null) {
            int i3;
            int i4;
        ...
        if (zzaArr != null) {
            ...
            for (zza zza : zzaArr) {
                if (zza != null) {
                    ...
                    zza(stringBuilder, i2, "audience_id", zza.zzbvh);
                    zza(stringBuilder, i2, "new_audience", zza.zzbvT);
                    zza(stringBuilder, i2, "current_data", zza.zzbvR);
                    zza(stringBuilder, i2, "previous_data", zza.zzbvS);
                    zza(stringBuilder, i2);
                    stringBuilder.append("}\n");
                }
            }
    ...
    private static void zza(StringBuilder stringBuilder, int i, zzauh.zzb[] zzbArr) {
        if (zzbArr != null) {
            int i2 = i + 1;
            for (zzauh.zzb zzb : zzbArr) {
                if (zzb != null) {
                    ...
                    zza(stringBuilder, i2, "timestamp_millis", zzb.zzbvW);
                    zza(stringBuilder, i2, "previous_timestamp_millis", zzb.zzbvX);
                    zza(stringBuilder, i2, "count", zzb.count);
                    zza(stringBuilder, i2, zzb.zzbvV);
                    zza(stringBuilder, i2);
                    stringBuilder.append("}\n");
                }
            }
    ...
    private static void zza(StringBuilder stringBuilder, int i, zzauh.zzc[] zzcArr) {
        if (zzcArr != null) {
            int i2 = i + 1;
            for (zzauh.zzc zzc : zzcArr) {
                if (zzc != null) {
                    ...
                    zza(stringBuilder, i2, "string_value", zzc.zzaFy);
                    zza(stringBuilder, i2, "int_value", zzc.zzbvZ);
                    zza(stringBuilder, i2, "double_value", zzc.zzbvc);
                    zza(stringBuilder, i2);
                    stringBuilder.append("}\n");
                }
            }
        ...
        if (zzgArr != null) {
            ...
            for (zzg zzg : zzgArr) {
                if (zzg != null) {
                    ...
                    zza(stringBuilder, i2, "set_timestamp_millis", zzg.zzbwF);
                    zza(stringBuilder, i2, "name", zzg.name);
                    zza(stringBuilder, i2, "string_value", zzg.zzaFy);
                    zza(stringBuilder, i2, "int_value", zzg.zzbvZ);
                    zza(stringBuilder, i2, "double_value", zzg.zzbvc);
                    zza(stringBuilder, i2);
                    stringBuilder.append("}\n");
                }
            }
