...
public class zzlr extends zzlm {
    ...
    zzlr(Context context, zza zza, zzjs zzjs, zzln.zza zza2, zzgf zzgf, zzqp zzqp) {
    ...
    private static String zzg(List<zzjn> list) {
        ...
        String str2 = str;
        for (zzjn zzjn : list) {
            if (!(zzjn == null || zzjn.zzKA == null || TextUtils.isEmpty(zzjn.zzKA.zzJJ))) {
                str2 = String.valueOf(str2);
                str = String.valueOf(zza(zzjn));
