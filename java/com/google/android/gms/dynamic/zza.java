...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    private final zzf<T> zzaQg = new C06321(this);

    /* renamed from: com.google.android.gms.dynamic.zza$5 */
    class C02775 implements OnClickListener {
        final /* synthetic */ Intent zzaQm;
        final /* synthetic */ Context zztd;

        C02775(Context context, Intent intent) {
            this.zztd = context;
            this.zzaQm = intent;
        }
    ...
    static void zza(FrameLayout frameLayout, GoogleApiAvailability googleApiAvailability) {
        ...
        if (zzb != null) {
            ...
            button.setOnClickListener(new C02775(context, zzb));
        }
    }
