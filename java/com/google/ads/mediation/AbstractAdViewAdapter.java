...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationNativeAdapter, MediationRewardedVideoAdAdapter, zzrd {
    ...
    final RewardedVideoAdListener zzcI = new C06091(this);

    /* renamed from: com.google.ads.mediation.AbstractAdViewAdapter$1 */
    class C06091 implements RewardedVideoAdListener {
        final /* synthetic */ AbstractAdViewAdapter zzcJ;

        C06091(AbstractAdViewAdapter abstractAdViewAdapter) {
    ...
    public void loadAd(MediationAdRequest mediationAdRequest, Bundle bundle, Bundle bundle2) {
        if (this.zzcF == null || this.zzcH == null) {
            zzpy.m9e("AdMobAdapter.loadAd called before initialize.");
            return;
        }
    ...
    public void requestNativeAd(Context context, MediationNativeListener mediationNativeListener, Bundle bundle, NativeMediationAdRequest nativeMediationAdRequest, Bundle bundle2) {
        OnContentAdLoadedListener zze = new zze(this, mediationNativeListener);
        Builder withAdListener = zza(context, bundle.getString(AD_UNIT_ID_PARAMETER)).withAdListener(zze);
