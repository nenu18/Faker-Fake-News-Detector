...
public class FirebaseInstanceId {
    ...
    void zzjv(String str) throws IOException {
        ...
        zzd.getToken(str3, valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf), bundle);
    }
    ...
    void zzjw(String str) throws IOException {
        ...
        valueOf = String.valueOf("/topics/");
        valueOf2 = String.valueOf(str);
        zzd.zzb(str3, valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf), bundle);
    }
}
