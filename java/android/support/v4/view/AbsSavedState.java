...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C05582());
    public static final AbsSavedState EMPTY_STATE = new C05571();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C05571 extends AbsSavedState {
        C05571() {
            super();
        }
    }
    ...
    static class C05582 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C05582() {
        }
