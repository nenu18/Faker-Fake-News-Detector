...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C05083();
    ...
    class C05072 implements OnApplyWindowInsetsListener {
        C05072() {
        }
    ...
    class C05083 implements Callback {
        C05083() {
        }
    ...
    class C05094 implements OnDismissListener {
        C05094() {
        }
    ...
    class C05105 implements OnAttachStateChangeListener {
    ...
    class C05116 implements OnLayoutChangeListener {
        C05116() {
        }
    ...
    class C07897 extends ViewPropertyAnimatorListenerAdapter {
        C07897() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C05072());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C05094());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C05105());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C05116());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C07897()).start();
            return;
        }
