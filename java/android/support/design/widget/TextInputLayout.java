...
public class TextInputLayout extends LinearLayout {
    ...
    class C05305 implements AnimatorUpdateListener {
        C05305() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05311());
        CharSequence error;

        /* renamed from: android.support.design.widget.TextInputLayout$SavedState$1 */
        static class C05311 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05311() {
            }
    ...
    class C07932 extends ViewPropertyAnimatorListenerAdapter {
        C07932() {
        }
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C07932()).start();
            } else {
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C05305());
            }
