...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C05181 implements OnApplyWindowInsetsListener {
        C05181() {
        }
    ...
    class C05192 implements AnimatorUpdateListener {
        C05192() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05181());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C05192());
