...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C05152 extends AccessibilityDelegateCompat {
        C05152() {
        }
    ...
    class C05163 extends BottomSheetCallback {
        C05163() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C05163();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C05152());
        return coordinator;
    }
