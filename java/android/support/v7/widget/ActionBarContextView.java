...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setBackground(this, a.getDrawable(C0170R.styleable.ActionMode_background));
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0170R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
