...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C06062();
    ...
    class C06062 implements OnItemTouchListener {
        C06062() {
        }
    ...
    class C06075 implements ChildDrawingOrderCallback {
        C06075() {
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C06075();
            }
