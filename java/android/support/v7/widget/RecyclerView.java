...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    class C05974 implements ProcessCallback {
        C05974() {
        }
    ...
    class C05985 implements Callback {
        C05985() {
        }
    ...
    class C05996 implements Callback {
        C05996() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C05974();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C05985());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C05996());
    }
