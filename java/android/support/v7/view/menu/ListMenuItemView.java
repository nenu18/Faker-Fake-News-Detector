...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0170R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0170R.styleable.MenuView, defStyleAttr, 0);
        ...
        this.mSubMenuArrow = a.getDrawable(C0170R.styleable.MenuView_subMenuArrow);
        a.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        this.mSubMenuArrowView = (ImageView) findViewById(C0170R.id.submenuarrow);
