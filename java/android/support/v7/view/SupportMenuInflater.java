...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            ...
            this.groupId = a.getResourceId(C0170R.styleable.MenuGroup_android_id, 0);
            this.groupCategory = a.getInt(C0170R.styleable.MenuGroup_android_menuCategory, 0);
            this.groupOrder = a.getInt(C0170R.styleable.MenuGroup_android_orderInCategory, 0);
            this.groupCheckable = a.getInt(C0170R.styleable.MenuGroup_android_checkableBehavior, 0);
            this.groupVisible = a.getBoolean(C0170R.styleable.MenuGroup_android_visible, true);
            this.groupEnabled = a.getBoolean(C0170R.styleable.MenuGroup_android_enabled, true);
            a.recycle();
        }

        public void readItem(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0170R.styleable.MenuItem);
            this.itemId = a.getResourceId(C0170R.styleable.MenuItem_android_id, 0);
            ...
            this.itemIconResId = a.getResourceId(C0170R.styleable.MenuItem_android_icon, 0);
            ...
            if (a.hasValue(C0170R.styleable.MenuItem_android_checkable)) {
                int i;
                if (a.getBoolean(C0170R.styleable.MenuItem_android_checkable, false)) {
                    i = 1;
                } else {
                    i = 0;
                }
            ...
            this.itemChecked = a.getBoolean(C0170R.styleable.MenuItem_android_checked, false);
            ...
            this.itemActionViewLayout = a.getResourceId(C0170R.styleable.MenuItem_actionLayout, 0);
