...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C08041();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C08052();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05813();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C05813 implements ViewPropertyAnimatorUpdateListener {
        C05813() {
        }
    ...
    class C08041 extends ViewPropertyAnimatorListenerAdapter {
        C08041() {
        }
    ...
    class C08052 extends ViewPropertyAnimatorListenerAdapter {
        C08052() {
        }
